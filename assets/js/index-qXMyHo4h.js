...
const au = "Login Machine",
	...
	vm = (rt = {}) => {
		...
		const xt = Dt => {
				...
				Mt(It), setIsChecking(!0), ot && (ot.value || (ot.value = !0));
				const ae = It.length;
				yt && (yt.value = ae * Ct)
			},
			Yt = () => {
				setIsChecking(!0), ot && (ot.value = !0), yt && yt.value !== B.length * Ct && (yt.value = B.length * Ct)
			};
			const xm = (Dt, It = !1) => {
