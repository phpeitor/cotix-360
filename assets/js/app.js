class App {
	...
	initFormAdvance() {
		...
		document.querySelectorAll("[data-choices]").forEach(function(e) {
			...
			// ⛔ EVITA crear doble instancia
			if (e.dataset.choicesInitialized === "true") return;
			e.dataset.choicesInitialized = "true";
			...
			let instance = new Choices(e, config);

			// Guarda la ÚNICA instancia válida
			e.choicesInstance = instance;
